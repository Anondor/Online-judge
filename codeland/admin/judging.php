...
<body style=""><div class="header "style=" position: -webkit-sticky; position: sticky; top: 0;">
            ...
            <div class="nav">
                ...
                <div class="nav-1">
                      <ul>
                            ...
                            <li class="nav-item" id="nav-problem"> <a class="nav-link" href="Code.php">Code</a></li>
    ...
    $status="in queue";
    	...
    	$sql = "SELECT * FROM usersubmission WHERE status='$status'";
    	$querydisplay    =mysqli_query($conn, $sql);
    	while($result=mysqli_fetch_array($querydisplay))
             {
        ?>
        <tr>
            <td><?php echo $result['submissionid']; ?></td>
 

             <td>
        <a href="<?php echo $result['link']; ?>">     Problem Link </a></td>
             <br>
