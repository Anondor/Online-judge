                ...
                <div class="nav-1">
                      <ul>
                            ...
                            <li class="nav-item" id="nav-volume">   <a class="nav-link" href="../volume/volume.php">Volume</a> </li>
                             <li class="nav-item" id="nav-volume">   <a class="nav-link" href="submission.php">Submission</a> </li>
                      </ul>                     
                </div>
...
<div  class="middle" style="background-color: #F4F0FF;">
  <div class="container">
    ...
    $conn=mysqli_connect('localhost','root','','codeland');
     ...
     $s   = "SELECT * FROM `usersubmission`  ORDER BY submissionid DESC where username='$username'";
